...
VA = os.path.join(os.getcwd(), '../data/VA.mat')
LUAD_P = os.path.join(os.getcwd(), '../data/LUAD_P.mat')
LUSC_P = os.path.join(os.getcwd(), '../data/LUSC_P.mat')
Brain_P = os.path.join(os.getcwd(), '../data/Brain_P.mat')
LUAD_G = os.path.join(os.getcwd(), '../data/LUAD_G.mat')
LUSC_G = os.path.join(os.getcwd(), '../data/LUSC_G.mat')
