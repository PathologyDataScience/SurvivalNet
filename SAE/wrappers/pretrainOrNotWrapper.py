...
def wrapper():
    pathout = '/home/syouse3/git/Survivalnet/SAE/results/LUAD-Oct26/PretrainOrNot/'
        ...
        for n_layer in layers:
            for pretrain in pt_ops:
                for do_rate in do_rates:
                    test_SdA(finetune_lr=0.01, pretrain=pretrain, pretraining_epochs=400, n_layers=n_layer,\
